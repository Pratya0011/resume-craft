  ...
  return (
    <div className="App">
      ...
      <h1 className='header'>Resume Craft</h1>
          ...
          {/* <button className="crt-btn">Create My Resume</button> */}
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path='/update/personalDetails' element={<UpdatePersonal/>}></Route>
          <Route path='/update/about' element={<UpdateAbout/>}></Route>
          <Route path='/update/Education' element={<UpdateEducation/>}></Route>
          <Route path='/update/experience' element={<UpdateExperience/>}></Route>
